...
export default function QueryExecutionPage() {
  ...
  useEffect(() => {
    ...
    const filtered = results.filter((row) => {
      ...
      const quantityMatch =
        (!filters.prod_quantity_min ||
          parseFloat(row.prod_quantity) >=
            parseFloat(filters.prod_quantity_min)) &&
        (!filters.prod_quantity_max ||
          parseFloat(row.prod_quantity) <=
            parseFloat(filters.prod_quantity_max));
      ...
      const discountMatch =
        (!filters.prod_discount_min ||
          parseFloat(row.prod_discount) >=
            parseFloat(filters.prod_discount_min)) &&
        (!filters.prod_discount_max ||
          parseFloat(row.prod_discount) <=
            parseFloat(filters.prod_discount_max));
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-indigo-50 to-gray-100 p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-gray-600">Products sorted by price (descending)</p>
        </div>
          ...
          <div className="p-6">
            {isLoading ? (
              <div className="flex flex-col justify-center items-center h-40 gap-4">
                ...
                <p className="text-gray-600">Loading sorted results...</p>
              </div>
            ) : error ? (
