            ...
            <div className="my-10 flex flex-col md:flex-row gap-16 items-center">
              ...
              <div className="flex flex-col justify-center gap-6 md:w-1/2">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Welcome to our Database Management System project! This
                  e-commerce platform is developed by students of the Department
                  of Computer Science and Engineering, University of Dhaka.
                </p>
                <p className="text-gray-600 leading-relaxed">
                ...
                <div className="mt-4">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    ...
                    learning and implementing modern database management
                    practices.
                  </p>
                </div>
              </div>
